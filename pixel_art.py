...
# 入力画像を取得
#img = cv2.imread("/Users/miyagawatakuya/.spyder-py3/OpenCV_Test/img/chihiro.jpg")
img = cv2.imread("/Users/miyagawatakuya/.spyder-py3/OpenCV_Test/img/sekimaru.jpg")

# ドット絵化 （img, alpha=小さいほど荒くなる, K=大きいほど色合いが落ちる）
dst = pixel_art(img, 0.5, 3)
    
# 結果を出力
cv2.imshow('pixel',dst)  #新しいウィンドウを開き画像を映し出す
cv2.imwrite("/Users/miyagawatakuya/.spyder-py3/OpenCV_Test/output/sekimaru.jpg", dst)
